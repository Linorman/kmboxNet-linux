...
int kmNet_keypress(int vk_key, int ms); // ok
int kmNet_enc_keydown(int vkey); // ok
int kmNet_enc_keyup(int vkey); // ok
int kmNet_enc_keypress(int vk_key, int ms); // ok
...
// 物理键鼠屏蔽系列
int kmNet_mask_mouse_left(int enable); // 屏蔽物理鼠标左键
int kmNet_mask_mouse_right(int enable); // 屏蔽物理鼠标右键
int kmNet_mask_mouse_middle(int enable); // 屏蔽物理鼠标中键
int kmNet_mask_mouse_side1(int enable); // 屏蔽物理鼠标侧键1
int kmNet_mask_mouse_side2(int enable); // 屏蔽物理鼠标侧键2
int kmNet_mask_mouse_x(int enable); // 屏蔽物理鼠标X轴坐标
int kmNet_mask_mouse_y(int enable); // 屏蔽物理鼠标Y轴坐标
int kmNet_mask_mouse_wheel(int enable); // 屏蔽物理鼠标滚轮
int kmNet_mask_keyboard(short vkey); // 屏蔽物理键盘指定按键
int kmNet_unmask_keyboard(short vkey); // 解除物理键盘指定按键的屏蔽
int kmNet_unmask_all(); // 解除所有物理屏蔽物理键鼠
